...
const menuItems = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        name: "Listar Estudiantes en Curso",
        icon: "list",
        route: "ListEstudiantesPorCurso",
        onClick(item) {
          handleItemClick(item);
        },
      },
  ...
  },
  {
    ...
    children: [
      ...
      {
        name: "Registrar Profesores en Curso",
        icon: "fa-user-tie",
        route: "ProfesorPorCurso",
        onClick(item) {
          handleItemClick(item);
        },
      },
      ...
      {
        name: "Listar Profesores en Cursos",
        icon: "list",
        route: "ListProfesorPorCurso",
        onClick(item) {
          handleItemClick(item);
        },
      },

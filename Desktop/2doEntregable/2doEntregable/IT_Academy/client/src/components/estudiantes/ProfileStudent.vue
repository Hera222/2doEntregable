<template>
  ...
  <div class="form-marco">
    ...
    <h2 v-else class="form-titulo">Detalle Informativo del Estudiante</h2>
...
const getStudent = async (id) => {
  ...
  await fetch(api, {
    ...
    .catch((error) =>
      console.error("Error al editar la información del Estudiante:", error)
    );
};
...
const enviarDatosEstudiante = async () => {
  ...
  await fetch(api, {
    ...
    .catch((error) =>
      console.error("Error al grabar la información del Estudiante:", error)
    );
};
